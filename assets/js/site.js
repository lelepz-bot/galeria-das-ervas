...
function waLink(msg='Olá! Vim pelo site e gostaria de tirar uma dúvida.'){let n=asText(DATA.settings.whatsapp).replace(/\D/g,'');return `https://wa.me/${n||'SEU_NUMERO_AQUI'}?text=${encodeURIComponent(msg)}`}
